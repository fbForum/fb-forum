...
<table align="center" border="1" bordercolor="#ccc" cellpadding="5" cellspacing="0" style="border-collapse:collapse;" width="800">
	<thead>
		<tr>
	...
	<tbody>
        ...
        <p><input maxlength="255" name="topic" size="100" type="text" value="輸入標題" /></p>
			<p><textarea width="100%" cols="1" name="content" rows="1"></textarea></p>
